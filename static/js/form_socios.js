// ===== FORMULARIO MULTI-PASO PARA REGISTRO DE SOCIOS =====
...
class FormSocios {
    ...
    bindEvents() {
        ...
        // Navegación por pasos en la barra de progreso
    ...
    goToStep(stepNumber) {
        ...
        // Solo permite avanzar si los pasos anteriores están validados
    ...
    validatePersonalInfo(step) {
        // Validar que al menos se haya seleccionado una red social si existe el campo
    ...
    validateBusinessInfo(step) {
        // Validaciones específicas para información de negocio
        return true;
    }

    validateServicesInfo(step) {
        // Validar que se haya seleccionado al menos un tipo de negocio
    ...
    validateConfirmation(step) {
        // Validaciones específicas para el paso de confirmación
        return true;
    }
    ...
    isValidRucCedula(value) {
        // Validación básica para RUC/Cédula ecuatoriana
